...
<s:Group xmlns:fx="http://ns.adobe.com/mxml/2009" 
	...
	<fx:Declarations>
			...
			FLEXJSBL_PROJECT = new FileLocation("Generate FlexJS from Balsamiq Mockup");
			FLEXJSBL_PROJECT.fileBridge.name = "Generate FlexJS from Balsamiq Mockup";
			FLEXJSBL_PROJECT.fileBridge.isDirectory = true;
			FLEXJSBL_PROJECT.fileBridge.data = "Create a FlexJS project from Balsamiq Moqup.";
