...
package actionScripts.utils
{
	...
	public class SDKUtils extends EventDispatcher
	{
		...
		public static function openSDKUnzipPrompt():void
		{
			...
			{
				GlobalEventDispatcher.getInstance().dispatchEvent(new Event(HelpPlugin.EVENT_SDK_UNZIP_REQUEST));
			}
			...
			{
				GlobalEventDispatcher.getInstance().dispatchEvent(new Event(HelpPlugin.EVENT_SDK_HELPER_DOWNLOAD_REQUEST));
			}
			else 
			{
